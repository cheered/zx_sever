...
DROP TABLE IF EXISTS `answerdetails`;
...
LOCK TABLES `answerdetails` WRITE;
/*!40000 ALTER TABLE `answerdetails` DISABLE KEYS */;
/*!40000 ALTER TABLE `answerdetails` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `AnswerDetails_AFTER_INSERT` AFTER INSERT ON `answerdetails` FOR EACH ROW BEGIN
...
CREATE TABLE `questionnaires` (
  ...
  `customer_type` enum('个人','公司') DEFAULT NULL,
  `business_type` enum('理财','基金','资管','信托') DEFAULT NULL,
  `createTime` datetime DEFAULT CURRENT_TIMESTAMP,
  `updateTime` datetime DEFAULT CURRENT_TIMESTAMP,
  `isDeleted` tinyint DEFAULT '0',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='选项表，与问卷表关联';
/*!40101 SET character_set_client = @saved_cs_client */;
